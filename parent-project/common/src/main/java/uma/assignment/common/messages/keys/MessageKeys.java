...
public class MessageKeys {
	...
	public static final String ROUTINGKEY_EDIT = "uma.assignment.queue.booking.key.edit";
	public static final String ROUTINGKEY_DELETE = "uma.assignment.queue.booking.key.delete";
